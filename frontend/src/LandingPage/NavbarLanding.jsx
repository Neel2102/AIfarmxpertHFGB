...
export default function NavbarLanding() {
  ...
  if (loading) {
    return <header className="header-navbarlanding" style={{ height: '80px', opacity: 0.5 }}></header>;
  }
      ...
      <div className="container1">
        <nav className="navbar-navbarlanding">
          ...
          <div className="nav-actions-navbarlanding">
            ...
            {user ? (
              <div className="auth-profile-navbarlanding">
                <button 
                  className="profile-btn-navbarlanding"
                  onClick={handleDashboardClick}
                >
                  <div className="avatar-circle-navbarlanding">
                    {user.username?.charAt(0).toUpperCase() || 'U'}
                  </div>
                  <span className="profile-name-navbarlanding">{user.username}</span>
                </button>
                <button 
                  className="logout-icon-btn-navbarlanding"
