...
export default function HeroSection() {
  const titleBefore = 'Precision Farming';
  const titleAccent = 'Powered by AI';
  const titleAfter = 'Multi-Agent Intelligence';
  ...
  useEffect(() => {
    ...
    lineData.forEach((line, li) => {
      ...
      toGraphemes(line.text).forEach((ch) => {
    ...
    const BR = parseInt(rootStyles.getPropertyValue('--canvas-branch-r')) || 16;
    const BG = parseInt(rootStyles.getPropertyValue('--canvas-branch-g')) || 185;
    const BB = parseInt(rootStyles.getPropertyValue('--canvas-branch-b')) || 129;
    const SR = parseInt(rootStyles.getPropertyValue('--canvas-soil-r')) || 16;
    const SG = parseInt(rootStyles.getPropertyValue('--canvas-soil-g')) || 185;
    const SB = parseInt(rootStyles.getPropertyValue('--canvas-soil-b')) || 129;
    const SDR = parseInt(rootStyles.getPropertyValue('--canvas-seed-r')) || 16;
    const SDG = parseInt(rootStyles.getPropertyValue('--canvas-seed-g')) || 185;
    const SDB = parseInt(rootStyles.getPropertyValue('--canvas-seed-b')) || 129;
    const PR = parseInt(rootStyles.getPropertyValue('--canvas-pulse-r')) || 16;
    const PG = parseInt(rootStyles.getPropertyValue('--canvas-pulse-g')) || 185;
    const PB = parseInt(rootStyles.getPropertyValue('--canvas-pulse-b')) || 129;
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-text-block">
        <h1 className="hero-title" id="heroTitle" aria-label="Precision Farming Powered by AI Multi-Agent Intelligence">
          Precision Farming Powered by AI Multi-Agent Intelligence
        </h1>
        <p className="hero-desc">
          FarmXpert deploys a network of specialized AI agents that continuously
          monitor soil, weather, crops, and markets — delivering real-time,
          hyper-local intelligence to every acre of your farm.
        </p>
        <div className="hero-actions">
          {/* CTAs can be wired here */}
        </div>
      </div>

      {/* Surface line */}
      <div className="surface-line" id="surfaceLine"></div>
      <div className="surface-lbl" id="surfaceLbl">SOIL SURFACE</div>
      ...
      <div className="hero-stats">
        <div className="stat-card">
          ...
          <span className="stat-label">Pest Accuracy</span>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          ...
          <span className="stat-label">Farm Nodes</span>
        </div>
        <div className="stat-card">
