...
class RuleEngine:
    ...
    def _dry_spell_rule(self, forecasts: List[WeatherForecast]) -> Optional[RiskAlert]:
        ...
        logger.warning(f"Dry spell rule triggered: {consecutive_dry} consecutive dry days")
    ...
    def _high_rain_probability_rule(self, forecasts: List[WeatherForecast]) -> Optional[RiskAlert]:
        ...
        logger.warning(f"High rain probability rule triggered: {high_rain_days} days")
