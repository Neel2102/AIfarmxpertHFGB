...
class AgentConfigService:
    ...
    def validate_agent_input(self, agent_name: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        standardized_input = dict(input_data or {})
        ...
        common_fields = {
            ...
            "request_source": input_data.get("request_source"),
        ...
        if agent_name == "weather_watcher":
            ...
            standardized_input.update({
                ...
                "soil_moisture_percent": input_data.get("soil_moisture_percent"),
                "soil_moisture_measured_at": input_data.get("soil_moisture_measured_at"),
                "rain_last_3_days_mm": input_data.get("rain_last_3_days_mm"),
            ...
            standardized_input.update({
                "soil_type": input_data.get("soil_type"),
                "depth_cm": input_data.get("depth_cm"),
                "location": input_data.get("location"),
            })
            ...
            crop_data = input_data.get("crop", {})
            crop_info_in = input_data.get("crop_info", {})
            standardized_input.update({
                "crop_info": {
                    "name": crop_data.get("crop_name", crop_data.get("name", "unknown")),
                    "area_hectares": crop_data.get("area_hectares", 1.0),
                    "growth_stage": (crop_info_in.get("growth_stage") if isinstance(crop_info_in, dict) else None),
                },
