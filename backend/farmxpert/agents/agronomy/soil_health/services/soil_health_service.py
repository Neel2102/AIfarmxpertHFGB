...
from farmxpert.agents.agronomy.soil_health.models.input_models import SoilHealthInput, QuickSoilCheckInput
from farmxpert.agents.agronomy.soil_health.models.output_models import (
    SoilHealthAnalysis, SoilIssue, Recommendation, SoilRecommendations,
    HealthScoreBreakdown, QuickSoilCheckResult
)
from farmxpert.agents.agronomy.soil_health.constraints.soil_constraints import (
...
class SoilHealthAnalysisService:
    ...
    def quick_soil_check(input_data: QuickSoilCheckInput) -> QuickSoilCheckResult:
        ...
        try:
            ...
            soil_data_dict = input_data.dict()
...
def run_soil_health(sensor_data: dict) -> dict:
    ...
    try:
        ...
        from farmxpert.agents.agronomy.soil_health.models.input_models import QuickSoilCheckInput
