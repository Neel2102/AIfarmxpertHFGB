...
class User(Base):
    ...
    role = Column(String(20), default="farmer", index=True)
...
# Note: Farm, Crop, SoilTest, Task, Yield models are defined in farm_models.py to match existing database schema
